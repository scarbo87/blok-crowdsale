...
contract('MultiSigWallet', (accounts) => {
    ...
    describe('fallback function', async () => {
        ...
        it('should receive BLO', async () => {
            let token = await BlokToken.new();
        ...
        [
            ...
            context(`with ${spec.owners.length} owners and requirement of ${spec.requirement}`, async () => {
                ...
                beforeEach(async () => {
                    ...
                    await token.mint(wallet.address, initBLOBalance);
                    await token.endMinting();
                    assert.equal((await token.balanceOf(wallet.address)).toNumber(), initBLOBalance);
